...
# 建立一个基于CNN的人脸识别模型
class Model(object):
    FILE_PATH = r"C:\Users\01436179\PycharmProjects\pyhton_face\model\model1.h5"
    # 模型进行存储和读取的地方
    IMAGE_SIZE = 128
    ...
    def train_model(self):
        self.model.compile(
            optimizer='adam',
            # 有很多可选的optimizer，例如RMSprop,Adagrad，你也可以试试哪个好，我个人感觉差异不大
            loss='categorical_crossentropy',
            # 你可以选用squared_hinge作为loss看看哪个好
            metrics=['accuracy'])
...
if __name__ == '__main__':
    dataset = DataSet(r"C:\Users\01436179\PycharmProjects\pyhton_face\source_train")
    model = Model()
